      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden">
        <div className="p-8">
          <div className="flex justify-center mb-8">
            <img src={logo} alt="Sweekar Logo" className="w-32 h-32 rounded-full border-4 border-lavender-300 shadow-lg" />
          </div>
          <h2 className="text-3xl font-bold text-center text-lavender-900 mb-2">Welcome to Sweekar</h2>
          <p className="text-center text-lavender-600 mb-8">Please sign in to continue</p>
          <button
